        ...
        with TabbedContent(initial="logging"):
            category_config = [
                (
                    "📝 Logging",
                    "logging",
                    ["basic", "tags", "project", "combined", "date"],
                ),
                ...
                (
                    "🔍 Search",
                    "search",
                    ["tui", "fuzzy", "filter_project", "filter_tag", "type"],
                ),
        ...
        example_map = {
            "logging": {
                ...
                "project": (
                    ...
                    "Add entries with a project:",
                ),
                "combined": (
                    "Multiple Tags & Project",
                    'dwriter add "refactored database" -t refactor -t backend -p myapp',
                    "Combine tags and projects:",
                ),
                "date": (
                    "With Date",
                    'dwriter add "Finished report" --date yesterday',
                    "Add entries for a specific date:",
                ),
            },
            "viewing": {
                "today": (
            ...
            "standup": {
                "generate": (
                    "Generate Standup",
                    "dwriter standup",
                    "Create yesterday's summary (copies to clipboard):",
                ),
                "formats": (
                    "Formats",
                    "dwriter standup --format slack",
                    "Different output formats (slack, jira, markdown):",
                ),
                "options": (
                    "Options",
                    "dwriter standup --with-todos",
                    "Include pending tasks with --with-todos:",
                ),
            },
            "review": {
            ...
            "timer": {
                ...
                "tagged": (
                    "With Tags",
                    "dwriter timer 45 -t deepwork",
                    "Timer with tags and project:",
                ),
            },
            "search": {
            ...
            "stats": {
                "dashboard": (
                    "Dashboard",
                    "dwriter stats",
                    "Interactive dashboard with calendar, charts, and statistics:",
                ),
            },
            "config": {
                "show": (
    ...
    def action_toggle_toc(self) -> None:
        ...
        try:
            viewer = self.query_one(
                f"#{active_category}-{subtab}-viewer", MarkdownViewer
            )
