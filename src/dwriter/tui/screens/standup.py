...
class StandupScreen(ModalScreen[None]):
    ...
    .controls { height: auto; min-height: 3; margin-bottom: 1; }
    .control-label { color: $text-muted; text-style: bold; content-align: center middle; padding-top: 1; margin-right: 1; }
